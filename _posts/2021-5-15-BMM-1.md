...
There are some approximate nearest neighbor search algorithms that try to solve these issues, such as HNSW, PQ and LHS. I have implemented IVFPQ and IVFPQ+R earlier this year, if you're interested you can [take a look](https://github.com/DeMoriarty/TorchPQ).
