...
note: all of the kernel optimizations are targeted towards compute capability 7.5 (Turing) devices, all experiments are done with a Tesla T4 GPU on Google Colab. Performance on other GPUs are not optimal.
